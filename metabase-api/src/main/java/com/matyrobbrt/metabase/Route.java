...
public record Route<T>(
        ...
        Function<com.matyrobbrt.metabase.RequestParameters, JsonElement> bodyGetter,
    ...
    public Request<T> compile(com.matyrobbrt.metabase.RequestParameters parameters) {
        return new Request<>(
