...
export type GetMixinsQuery = { gameVersion: { __typename: 'GameVersion', classDefinitions: { __typename: 'ClassDefinitionConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null }, edges: Array<{ __typename: 'ClassDefinitionEdge', node: { __typename: 'ClassDefinition', name: string, mod: { __typename: 'LightweightMod', name: string, curseforgeProjectId: number | null, modrinthProjectId: string | null }, annotations: Array<{ __typename: 'Annotation', type: string, value: unknown | null }> } }> } } | null };
